...
updated_at: 2026-03-06T23:46:39.142Z
categories: ["AWS"]
tags: ["Integration", "aws", "serverless"]
series:
  name: AWS
  slug: aws
thumbnail: https://mirror-cdn.swua.kr/thumbnails/aws/aws-appsync-graphql-serverless_960x540.png
linked_posts:
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/cba529c8-d0c5-4a37-9844-7490e055a29a.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/1707c301-e112-4c5f-97c2-7c4844f245d1.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/48cd46ce-a3f1-4a28-97e9-9d7781b88f0b.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/4b57f2f3-9bb2-4220-95c5-e07452a8a9d4.png)

회원가입 시 사용자 이름과 비밀번호, 이메일을 입력하도록 하고 로그인 시 사용자 이름과 비밀번호를 입력하도록 설정하였다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/8375d579-9588-4424-accd-e0897cbf651c.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/2b06b0e3-1f83-4672-b57e-fbeb3d5b48f4.png)

이렇게 Cognito 유저 풀과 애플리케이션을 생성해주었다. 로그인 페이지로 들어가서 회원가입을 해보자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/69f8092c-9000-40bf-9c58-a731b2ed0910.png)

이메일 제공을 필수로 해두었기 때문에 이메일 인증이 필요하다. 

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/e0535ed0-22cd-4a75-9c8a-021ebf7c7ac4.png)

그러면 위 사진과 같이 사용자가 생성되었다. test 유저의 JWT 토큰을 가져와보자. (아래와 같이 인증 흐름 설정이 되어있어야 한다. `ALLOW_USER_PASSWORD_AUTH`)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/88c72539-40ea-4168-a7ae-bf4ace718822.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/e9562a18-ceac-4512-ab35-8026939ca994.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/72d23fe0-7225-46dd-ac65-af80b5a62ab8.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/d45f4fb0-9749-45c7-a12d-b20bf31ec0c8.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/8a7203ee-060d-44a8-9242-5664051d1dca.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/9c693ce2-d60f-40bc-bd14-a57925f5bd35.png)

기본 템플릿을 설정할 수 있는데 무시하고 넘어가자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/27914cd3-f6d0-4e5b-9f2e-c3f508d25fc1.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/35995b55-5792-4fda-9dab-418b509f187f.png)

그리고 스키마를 정의하기 전, "설정"으로 가서 인증 방식을 추가해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/a3929206-181d-4fdf-b2de-f66365097271.png)

기본 권한 부여 모드는 API 키로 되어있는데, 밑에 추가 권한 부여 모드에 Cognito 방식을 추가해줘야 한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/326a4182-69cc-401e-9fa8-6d4f1b7fd1f4.png)

Cognito 유저 풀을 선택해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/e832702c-6d61-46a4-a6af-634565d49fbd.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/9987c0b8-c045-461d-9621-49afd2556136.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/929c37bb-b41b-4bc8-ad41-3ab09bd42507.png)

생성을 클릭한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/ed2fc103-94fb-45da-af64-2afe75706caf.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/ae1ff328-787b-44d7-a69f-81ed58dd114d.png)

그럼 뮤테이션과 쿼리가 보이는데, 여기서 Resolver를 작성할 수 있다. getPost() 쿼리를 첫번째로 연결해보자. 연결 버튼을 클릭한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/5b7a545a-3241-48f4-8b0a-894cab3148d8.png)

Resolver 유형은 단위 Resolver로 선택한다. 파이프라인은 AppSync 함수를 여러개 붙여서 순차적으로 Resolve하는 기능이다. 

그리고 Resolver 런타임은 JavaScript로 선택한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/44e929ef-3064-419c-8a06-47aa5504f639.png)

데이터 소스는 생성해둔 DynamoDB 테이블을 선택한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/56951963-ecb3-46ff-82b7-75987e46e924.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/634804c8-554e-4572-9efc-bd82a349e149.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/e0f164b6-d2df-47fd-b4f0-a9d5098e370b.png)

저장을 해주고, 잘 실행되는지 확인해보자. 

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/4b79c1c7-d219-4690-ab82-77ff740a0f0f.png)

Postman으로 테스트해봐도 되지만 콘솔에서 쿼리를 날려볼 수 있다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/1e654fdb-df7a-498f-9cc0-11e040ce1bfc.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/b777f523-30a5-471e-b196-63826e98a39b.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/4cb9fcca-bdee-4312-966c-369eb2475766.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/65f70933-67bc-4b63-8ad4-a8b2857ef781.png)

createPost 부터 테스트해보자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/1b5e8a42-12f5-4f1c-b661-f297b889e5f2.png)

실행 후 listPosts 쿼리를 보내보면 에러가 날 것이다. 

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/f84f1f8b-40dc-4e2f-88df-8d51e74b2ab8.png)

listPosts와 getPost는 API 키를 사용하도록 하였기 때문이다. 헤더에 `x-api-key`를 추가해주자. (API 키는 AppSync 설정에서 확인할 수 있다.)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/3514bacf-55e4-4803-ad6f-32af037f8f19.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/c82e812a-6b7b-446a-b910-85dbd23faf4e.png)

getPost도 테스트해보자.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/ae8a4c0a-1ef9-491b-a08c-cfd1eb4cae51.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/84dfd7e5-3d4e-4686-83b1-b3e01875fe36.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/2192a665-110e-4304-a3c9-f8befdbd5f99.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/f32255a0-85b3-41d4-97df-4be0e6231f06.png)

만약 다른 계정으로 업데이트하거나 삭제하려고 시도한다면 아래와 같이 에러를 반환한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/394f45ea-4530-4596-b9c0-01c09e9137db.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/e989d253-0b16-4065-9e00-e7b882bcb74e.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-08-28-aws-appsync-graphql-serverless/7c6ec3a6-d553-4ae4-9369-4c503408f51c.png)

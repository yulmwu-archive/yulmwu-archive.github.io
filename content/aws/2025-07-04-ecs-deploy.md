...
updated_at: 2026-03-06T13:53:30.138Z
categories: ["AWS"]
tags: ["Computing", "aws"]
series:
  name: AWS
  slug: aws
thumbnail: https://mirror-cdn.swua.kr/thumbnails/aws/ecs-deploy_960x540.png
linked_posts:
  previous: 
...
> ![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/f8661f30-a053-4640-b730-b045b3ce5ea0.png)
> 
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/16bd8bc6-bc3d-43b2-a1f6-2fb2a0c95d7e.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/4f9689f5-3c55-4be5-9b51-5697e9ad1e0e.png)

뭘 한것도 없는데 초반에 요금이 15달러로 시작하여 최종적으로 20.66달러로 꽤나 요금이 나왔다는 것이다.

그래서 원인이 뭔지 분석을 해보았는데, 그 범인을 찾았다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/b002bec0-ce4c-4a8a-91ae-6f26b9a5abe4.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/e1531ab7-13ee-4c65-9805-8265e9ea4893.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/762f7979-b269-4797-b948-19b0ef2d49d3.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/9d33e2ef-8b3d-4c7d-8487-c97c820495d5.png)

그리고 레포지토리에 들어가서 한가지 설정을 더 해주도록 하자.

사이드바 메뉴에서 Lifecycle Policy에 들어가서 아래와 같은 수명 주기 정책 규칙을 생성해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/e25230af-36c2-4d70-8119-9470dc44725d.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/a625cc28-df1e-4714-820b-81084901d05a.png)

참고로 규칙들이 바로 적용되진 않고 12시간 간격으로 적용되는 듯 하다.

그럼 ECR 레포지토리 생성과 세팅은 끝났으며, 이제 도커를 사용하여 ECR 레포지토리에 이미지를 push해야한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/16d7dab3-31a4-4c2f-a5f9-8a3f32ca3ffd.png)

잘 모르겠다면 "푸시 명령 보기" 버튼을 눌러보면 자세히 확인할 수 있다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/36c62ab8-7ede-40fd-b75e-f9fe572150f1.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/38050a76-5a6b-48df-a2aa-a55f088277b7.png)

그리고 그 이미지에 대한 태그를 새롭게 생성해준다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/09eb400c-dba9-445a-837d-4895f2070917.png)

마지막으로 위와 같이 이미지를 push 해주면 ECR 레포지토리에 업로드되는 것을 볼 수 있다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/c2550b6a-2cec-450a-87f1-73967a5a19fb.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/dad48b67-9ef5-4961-beee-34f0a9f34d66.png)

로드밸런서 유형은 Application Load Balancer(ALB)를 선택해준다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/151bd8de-be39-4c6f-84d5-1d337dd0a25c.png)

로드밸런서 이름을 정한 후 Internet Facing, IPv4 선택 후 다음으로 넘어간다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/25f1b17a-8a0b-41b2-aca7-88d414985ad9.png)

VPC는 맨 처음 만들어둔 VPC를 선택해주고 2개 이상의 서브넷을 선택해준다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/82b72fdd-d875-4f00-840e-93e09efc08d1.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/6ba2f3c2-b6c0-4fe9-acd6-35d7f6ef3a31.png)

먼저 클러스터를 만들자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/36d2e5a7-3cba-4293-8db7-587e338a38c1.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/5f484b5f-a0ef-4f37-af2a-f860d59e39a1.png)

이렇게 클러스터가 만들어지만 다음으로 서비스를 만들어야 하는데, 그 전에 태스크 정의를 통해 서비스의 태스크들이 어떻게 작동할지를 정해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/1dbb7b40-24ed-465b-b1ab-9a3f555ff78c.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/5703c9f0-5552-4426-9a71-70b7f3499461.png)

"새 태스크 정의 생성" 버튼을 클릭하여 태스크 정의를 생성하자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/6cbbfbca-84ad-4f73-9170-7e36caf6bbf8.png)

그리고 Fargate로 선택해주고, CPU는 0.5 vCPU, 1GB의 메모리를 선택해주었다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/b34e2538-dc8b-4603-8aed-1bd822ef6a32.png)

그리고 ECR에서 어떤 이미지를 가져올지 정해주고, 컨테이너의 3000번 포트를 열어주었다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/3f2116f7-0ac6-4d7d-a445-d546f2c58bcf.png)

이렇게 백엔드/프론트엔드 태스크 정의 2개를 만들어준다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/aaf55177-e136-449f-adbe-ce7d41175866.png)

그리고 서비스를 생성하는데 태스크 정의는 방금 만들었던 태스크 정의로 선택한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/d4be9393-f6a3-4bbd-a25c-af93840cb938.png)

그리고 Fargate에서도 EC2와 같이 스팟 요금을 지원한다. 앞서 NAT Gateway에 데여서 돈을 많이 쓰고 싶지 않기 때문에 스팟을 선택하였다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/ffe2adae-d604-466d-8f97-12b8c5c3933b.png)

네트워크에서는 만들어둔 VPC를 연결하고, 퍼블릭 IP는 활성화를 해두었다.
만약 NAT Gateway나 VPC 엔드포인트를 연결해두었다면 체크할 필요가 없다. 오히려 체크해두면 이것도 돈나간다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/3031ba54-9a13-428f-a8b3-5f3a2fe6e8df.png)

그리고 로드밸런서는 만들어둔 로드밸런서로, 리스너는 일단 80 포트로 연결해두었다. 이건 추후 다시 설정할 것이다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/cb2e2ce2-1d4d-4b28-a276-5426795c8464.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/07791967-ba53-4e37-9eae-2aac56d18107.png)

그럼 이렇게 자동으로 만들어지며, 컨테이너가 실행되게 된다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/4dbb52d8-149c-4e3d-a7ef-30f3f7dac580.png)

이제 로드밸런서에 들어와서 리스너 세팅을 해주자. 먼저 80번 포트 설정을 해주자.

이후 ACM을 사용하여 인증서 발급을 받아 HTTPS로 통신을 할 것이기 때문에 안해줘도 되긴 한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/138956e3-5edf-4e1d-8ba2-6b49405a9656.png)

이렇게 설정을 해주었고, 다음으로 HTTPS(443)도 똑같이 설정을 해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/fd24cfb1-0700-4cbb-bba1-5332c5e4fcee.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/aada7b12-865a-489e-9587-2098d80683a0.png)

HTTPS엔 인증서 선택이 가능한데, ACM에서 인증서를 발급받고 선택을 해주자.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/f842e133-92dc-4893-a08c-e5cd7594afee.png)

그럼 로드밸런서와 ECS 설정도 끝났다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/2b47d0c1-cfec-45de-bfe2-a1b7dbe51e5c.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/9e26223d-a116-409c-9ef6-7f3049a08f44.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/47e1fb6c-52f5-4c60-9c1c-5f1a615f9e4d.png)

먼저 최소 태스크의 개수와 최대 태스크 개수를 설정해준다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/e83d730b-603f-4112-8d43-f29bb95fdf35.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/49f69ea2-748e-444c-ac3a-041dc3dafd59.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/ddd75e2d-2991-4ed4-a37d-bb3aa2c2f0e0.png)

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/eac5943c-1f5f-4195-b4b0-11fe318af97b.png)

도메인 이름엔 우리가 구매한 도메인을 입력해두었다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/33760982-3e5c-4296-9bb3-3e2c84073031.png)

호스팅 영역을 만들면 위 사진과 같이 레코드에 기본 2개의 아이템이 들어가있다. 여기서 NS 유형의 "값/트래픽 라우팅 대상"을 가비아에 가서 DNS 설정해줘야 한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/0bb5ef07-e75c-4710-94df-acd5a2b537b7.png)

그럼 기본적인 Route53 도메인 설정은 끝이 나며, 연결된 도메인이 작동할 때 까지 최대 하루정도 걸리는 듯 하다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/1cf24ecf-a7e4-4666-bc4d-655cf46e7bde.png)

그리고 도메인의 레코드를 설정하여 서브 도메인을 설정하고, 그 라우팅 대상을 로드밸런서로 설정하였다.

그리고 ACM에서 HTTPS 인증서를 발급할 수 있으며, 발급 후 Route53과 연결해야 한다.

![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/ae14228a-2655-40cf-98e9-3d4269543482.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2025-07-04-ecs-deploy/1fd0ac92-1570-4d96-8030-7a542fa12475.png)

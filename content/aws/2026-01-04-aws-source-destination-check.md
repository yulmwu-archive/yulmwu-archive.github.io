...
updated_at: 2026-03-03T08:53:28.589Z
categories: ["AWS"]
tags: ["aws"]
series:
  name: AWS
  slug: aws
thumbnail: https://mirror-cdn.swua.kr/thumbnails/aws/aws-source-destination-check_960x540.png
linked_posts:
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/d2a8c8b9-77b0-4de4-9745-888ea37de6d7.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/057acbf1-e588-42e6-a9ac-6a5106c5f300.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/d6f6a931-61f9-42ac-8cdf-05a324b06148.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/385e4e0b-1c73-4084-bc6f-537d57c49e34.png)

NAT Instance에 대한 네트워크 설정에서는 퍼블릭 IP 자동 할당을 활성화하고, 아래와 같은 보안 그룹 설정을 해두자. 프라이빗 서브넷의 CIDR을 사용하면 된다. (`10.0.128.0/20`)

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/46ad168c-c822-4bc4-be7a-17766f6af534.png)

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/ebc90ef8-8524-4609-9df4-b0ccf1a49d23.png)

그리고 Private EC2는 아래와 같이 구성한다. Bastion Host 없이 SSM을 통해 접속해도 된다.

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/c6c98e0b-1bc4-49d9-ae10-71571921a975.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/ad5ee591-52f3-4cac-b663-d23c820a7157.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/3f795229-d744-4bb3-8985-ea46d7e8df6e.png)

## (5) Testing

이제 Private EC2에 Bastion Host나 SSM을 통해 접속하고 `curl`, `ping` 등의 명령어를 통해 `google.com` 접근 시 응답이 오는지 확인해보자.

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/832f510a-6f11-48af-8fc5-f53acb837366.png)

그럼 응답이 오지 않는데, NAT Instance에 대한 EC2 Source/Destination Check를 활성화 해두었기 때문이다. 

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/7e61c5bd-f206-4d62-b451-c6254f83756a.png)

NAT Instance에서 해당 옵션을 비활성화 할 수 있다. (Terraform 옵션으로는 `source_dest_check = false`)

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/bdacbd26-0c53-49f0-8710-dac6df4151f2.png)

그리고 다시 Private EC2에서 인터넷과 통신을 해보자. 예시로 `curl -I https://google.com`을 실행해보았다.

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/99d48b0b-cbb4-4bbd-8271-745176804ecf.png)
...
![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/7f3136fa-44f9-4571-bda3-fbd72142d326.png)

마지막으로 Private EC2에서 `curl https://checkip.amazonaws.com`을 입력하여 퍼블릭 IP가 무엇인지 확인해보자.

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/6942e8e3-03a5-4f8c-8549-87f0c22399b3.png)

위 `43.202.68.94` 퍼블릭 IP는 NAT Instance의 퍼블릭 IP와 동일한 것을 확인해볼 수 있을 것이다.

![](https://mirror-cdn.swua.kr/images/aws/2026-01-04-aws-source-destination-check/45e9f8af-d5ac-4144-810d-d467a31abb2f.png)

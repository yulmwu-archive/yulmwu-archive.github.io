...
updated_at: 2026-03-09T01:54:16.599Z
categories: ["Kubernetes"]
tags: ["aws", "eks", "kubernetes", "networking"]
series:
  name: Kubernetes
  slug: kubernetes
thumbnail: https://mirror-cdn.swua.kr/thumbnails/kubernetes/kubernetes-gateway_960x540.png
linked_posts:
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/bcadac7d-ad33-47c2-8857-4058afdd0de1.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/c2953b70-af3f-4bc3-9e9d-a9651a48ee29.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/7bbf54c1-7f97-4c5e-8fb2-85112b459e1a.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/ea61279c-6957-4b4b-b81b-7d7fe18eb5de.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/75c22078-9736-42ac-bb92-22c1614a9d5b.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/ac4e6adb-5073-4b6f-9cb9-162474458dc9.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/3ea98cbf-7158-49de-81a1-3594159b9b82.png)

그럼 아래와 같이 EKS 클러스터와 EC2 노드가 생성된다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/19499760-d32e-4752-a69d-5ff52bbcf9af.png)

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/84396bf9-bf78-4372-b842-ed935d4cca8e.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/ea3c72e8-a412-4791-a7d3-fd7f393b6d93.png)

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/844ac3ce-824a-448c-9fb5-cde5e5703068.png)

k9s에서 아무 파드나 잡고 S 키를 눌러 아래와 같이 테스트해보자.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/01578e90-e4c1-4adb-8527-87936456720e.png)
...
> 
> ![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/024d08ce-f256-4dec-ba25-6d11422bbd34.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/5ebc0653-e2b8-4ff0-b7f3-255bbd057fc5.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/1ffc65a4-fcdc-4771-a991-a3d7ca227ac3.png)

## (6) Lattice Service Network

그리고 AWS Lattice 서비스 네트워크를 만들어야 한다. (EKS 서비스, 대상 그룹 등은 Gateway API Controller가 만들어준다.)

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/8e702d55-c971-4f1e-9fa3-00e6d972db7b.png)

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/951b34b3-142f-44ba-aab6-4b8f05183166.png)

서비스 연결은 생략하고, VPC 연결을 해준다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/d3bd9891-5677-4332-b785-13b6dce53fbb.png)

인증도 생략한다. (실제 프로덕션 환경에선 Zero Trust를 위해 AWS IAM을 사용하는 것을 권장한다.)

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/2a20f2a6-2972-4dcf-aec3-6765e462e5f9.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/c98747ee-14bb-46eb-93aa-210774f9f470.png)

이걸 클라이언트 EC2에서 테스트해보자. 

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/845eda26-30cc-447f-93d0-8ae469e04414.png)

사진과 같이 라우팅도 되며, 다른 VPC에 있는 리소스이지만 잘 통신되는 것을 볼 수 있다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/1b8c18d4-9fda-4d18-96f2-e385790bbcb7.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/07913ee1-8c35-4018-8f24-2d2a24de12fe.png)

이제 Route 53 PHZ를 생성한다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/6399f36f-2550-44dc-b073-04005589905e.png)

"호스팅 영역 생성"을 클릭한다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/b6ee0ea2-f5b8-4e1e-9b7f-343e17383e55.png)

여기서 중요한 점은 "프라이빗 호스트 영역"으로 설정해야 한다. 도메인 이름은 `example.com`로 설정하였다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/f45fb219-a24e-4003-8fa0-5d3111bb096d.png)

VPC는 EKS VPC, Client VPC 둘 다 설정해주었다.

PHZ 생성이 되었다면 "레코드 생성"을 클릭한다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/7cff8b6e-3a4f-4fd2-83ea-77000285a163.png)

그리고 CNAME을 선택하고, 값엔 Lattice 서비스 도메인(HTTPRoute)을 입력한다. (새로 만들어진걸 적어야한다.)

레코드 이름(서브 도메인)은 `api`로 설정하였다.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/be80deec-bc8b-4024-a486-bb2528c32dd2.png)

그리고 테스트해보자.

![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/d8290875-c5f6-41da-9379-896d6334306f.png)
...
![](https://mirror-cdn.swua.kr/images/kubernetes/2025-09-09-kubernetes-gateway/f4605957-d9b5-4986-8090-2950fbc87d55.png)
